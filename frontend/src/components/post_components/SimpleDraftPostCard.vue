<template>
    <article class="max-w-3xl w-full flex flex-row items-start justify-between border border-gray-200 rounded-lg shadow 
      overflow-hidden h-[125px]">
        <div class="w-full h-full p-4 flex flex-col justify-between">
            ...
            <div>
                ...
                <p class="text-gray-600 text-xs md:text-sm">ultima actualizacion
